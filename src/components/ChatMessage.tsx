...
export const ChatMessage = ({
  ...
  return (
    <div className="flex mb-5 group animate-in fade-in slide-in-from-bottom-2 duration-300 w-full items-start justify-between gap-4">
        ...
        <div className="flex-1 min-w-0 pt-1.5">
          ...
          {message.content && message.content.trim() && (
            <div className="text-foreground">
              <p className="text-[14.5px] leading-relaxed whitespace-pre-wrap font-regular">
                {message.content}
              </p>
            </div>
          )}
            ...
            <div className="mt-3 space-y-3 flex flex-col items-start">
              ...
              >
                {attachments.map((attachment) => {
                  const isImage = attachmentService.isImage(
