            ...
            <div className="max-w-[85%] md:max-w-[70%] relative">
                ...
                {message.content && message.content.trim() && (
                    ...
                    >
                        ...
                        <div className={`flex items-center gap-1 mt-1 justify-end ${isMe ? 'text-white/70' : 'text-muted-foreground/60'}`}>
                ...
                {attachments.length > 0 && (
                    <div className="mt-3 space-y-3 items-start">
                        ...
                        <div className={`grid gap-3 ${attachments.length > 1 ? 'grid-cols-1 sm:grid-cols-2' : 'grid-cols-1'}`}>
                                    ...
                                    >
                                        ...
                                        <div className="p-3 bg-white flex items-center justify-between gap-2">
                                            <div className="min-w-0 flex-1">
                                                <p className="text-[12px] font-bold text-foreground truncate" title={attachment.file_name}>
