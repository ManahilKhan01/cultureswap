...
export const clearAuthStorage = (): void => {
    try {
        ...
        console.log('[Storage] Cleared auth storage successfully');
    } catch (e) {
...
export const safeSetItem = (key: string, value: string): boolean => {
    try {
        ...
        if (e instanceof DOMException && (
            ...
            console.warn('[Storage] Quota exceeded, clearing auth storage and retrying...');
            clearAuthStorage();
            ...
            try {
                ...
                console.error('[Storage] Failed to set item after clearing storage:', retryError);
                return false;
            }
        }
